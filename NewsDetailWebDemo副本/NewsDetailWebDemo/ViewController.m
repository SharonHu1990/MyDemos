...
//    myWeb.scalesPageToFit = YES;
    ...
    jsBridge = [WebViewJavascriptBridge bridgeForWebView:myWeb handler:^(id data, WVJBResponseCallback responseCallback) {
...
-(void)setupWebViewByData:(id)data{
    ...
    if (error) {
        ...
        for (id tag in tagArr) {
            ...
            tagBtnsHTML  = [tagBtnsHTML stringByAppendingString:[NSString stringWithFormat:@"<input type=\"submit\" class=\"tagBtn\" value=\"%@\">  ", tagName]];
        }

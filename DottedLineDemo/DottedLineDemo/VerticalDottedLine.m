...
#import "VerticalDottedLine.h"

@implementation VerticalDottedLine
...
- (void)drawRect:(CGRect)rect {
    ...
    [shapeLayer setPosition:CGPointMake(self.frame.size.width, self.frame.size.height/2.0)];
